...
1. **Web 本身就不是为金融安全设计的**——浏览器、Web 技术栈、域名系统，没有一个是金融级的
...
🔑 **硬件钱包**：保护私钥不假，但防不住你主动签名——你把门自己开了，锁再安全也没用

</v-click>

<v-click>

🖥️ **交易模拟**：能告诉你"将转 1 ETH"，但 Permit 签名当下链上无变化——它是一张"未来可兑现的授权票据"，钱包在模拟时，无法预知黑客会在“什么时候”、以“什么路由方式”、将这份授权提交给哪个具体的链上合约来卷走你的资产
...
**小模型够用吗**
	...
	专业场景里，只要 RAG / LoRA 等配套做好，小模型一样可以发挥出很不错的效果。
	随着模型和硬件的双向奔赴，不远的将来在手机 / HW 里可以跑起相当于当前 9B 能力的小模型
</v-click>
